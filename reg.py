...
var2=IntVar()
Checkbutton(root,text="Marathi", variable=var2).place(x=290,y=330)
var3=IntVar()
Checkbutton(root,text="Physics", variable=var3).place(x=230,y=350)
var4=IntVar()
Checkbutton(root,text="Chemistry", variable=var4).place(x=290,y=350)
